    ...
    >
      <div className="mb-6 text-center">
        ...
        <p className="mt-2 max-w-md text-sm text-slate-500">
          {isTeacher
            ? "You’re registering as a CurioSphere Teacher. We’ll email an OTP from CurioSphere to verify you. A new private class code is created every time you sign in."
            : "You’re registering as a CurioSphere Student. We’ll email an OTP from CurioSphere to verify your email."}
        </p>
        <div
      ...
      <p className="mt-6 text-center text-xs text-slate-400">
        OTP arrives from <strong>CurioSphere</strong>.{" "}
